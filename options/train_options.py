...
class TrainOptions(BaseOptions):
    def initialize(self):
        ...
        # for training
        self.parser.add_argument('--continue_train', type=bool,
                                 default=True, help='continue training: load the latest model')
                                 #/home/dung/Project/AI/tryon_fashion/DeepFashion_Try_On/checkpoints/label2city
        self.parser.add_argument('--load_pretrain', type=str, default='/home/dung/Project/AI/tryon_fashion/DeepFashion_Try_On/checkpoints/label2city',
